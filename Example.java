public class Example {
    ...
    static final String str = "/home/admin1/Tharun/Filesforjava/StockFiles/CompanyStock.json";
    ...
    public static <T> void buy() throws JsonGenerationException, JsonMappingException, IOException, ClassNotFoundException {
        ...
        if(flag<0) {
            ...
            if(s.getNumberShares()>share && share>0) {
                ...
                tempList.add(s);
                String json = ObjectOrientedPrograms.userWriteValueAsString1((Set<T>) tempList);
                ...
                String json1 = ObjectOrientedPrograms.userWriteValueAsString((List<T>) set);
